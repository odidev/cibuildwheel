...
native_docker_images = {"aarch64": "quay.io/pypa/manylinux2014_aarch64"}

# Cross triple for different architectures
cross_triple = {"aarch64": "/aarch64-unknown-linux-gnueabi/"}
...
class TargetArchEnvUtil:
    def __init__(
        ...
        self.toolchain_deps = cross_root + cross_triple[target_arch]
