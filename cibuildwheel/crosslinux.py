        ...
        try:
            ...
            with DockerContainer(
                ...
                if options.before_all:
                    ...
                    execute_cmd(docker, before_all_prepared, False, target_arch, env)
                for config in platform_configs:
                    ...
                    if options.before_build:
                        ...
                        execute_cmd(docker, before_build_prepared, True, target_arch, env)
                    ...
                    with DockerContainer(native_docker_images[target_arch], simulate_32_bit=platform_tag.endswith('i686'), cwd=container_project_path) as native_docker:
                        if options.repair_command:
                            ...
                            native_docker.call([target_arch_env.host_machine_tmp_in_container+'/repair_wheel.sh', target_arch_env.host_machine_deps_in_container, repair_command_prepared])
                        else:
                        ...
                        if options.test_command and options.test_selector(config.identifier):
                            ...
                            venv_dir = (
                                PurePath(native_docker.call(["mktemp", "-d"], capture_output=True).strip())
                                / "venv"
                            )
                            ...
                            if options.before_test:
                                ...
                                native_docker.call(["sh", "-c", before_test_prepared], env=virtualenv_env)
